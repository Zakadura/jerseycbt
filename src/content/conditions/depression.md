...
When depression keeps coming back — when it's less a single episode than a familiar place you return to — the pattern underneath matters more than this particular dip. That's where CAT fits. We map the patterns — often harsh, self-attacking ways of relating to yourself, learned a long time ago — as reciprocal roles, and early on I write you a **reformulation letter** setting out how they formed and what keeps them going. The choice between CBT and CAT is made together, at the first session. More on [how I work](/approach).
